    ...
    return (
        ...
        <div className="w-full h-full flex flex-col rounded-2xl border border-gray-200 p-3 shadow-sm hover:shadow-md hover:shadow-red-300 hover:scale-105 transition-all duration-300">
            ...
            <div className="mt-4  flex flex-col flex-1">
                ...
                {/* Bottom Row */}
                <div className="mt-auto flex items-center justify-end flex-1 pb-3">
                    {/* Price */}
                ...
                <Link href={`/explore-cars/${car._id}`}><Button variant="outline" className={'mt-auto w-full text-center text-[#c40101] text-xl py-10'}>View Details</Button></Link>
            </div>
        </div>
    )
}

export default CarCardAvailable;